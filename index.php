...
?>
		...
		<div class="item item-carousel border-success mb-3">
			<!-- <div class="products"> -->
	...
	<!-- <div class="product"> -->
	    ...
	    <a href="product-details.php?pid=<?php echo htmlentities($row['id']);?>">
				<img class="card-img-top" src="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" data-echo="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>"  width="180" height="300" alt=""></a>
	    <div class="card-body">
	      ...
	      <div class="rating rateit-small"></div>
			...
			<div class="product-price">	
				<span class="price">
		     	...
		     	<span class="price-before-discount" style="text-decoration: line-through; opacity: 0.5;">&#8358;<?php echo htmlentities($row['productPriceBeforeDiscount']);?>	</span>					
			</div>
	    </div>
	    <div class="card-footer">
	      <small class="text-muted"><a href="index.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm">Add to Cart</a></small>
	    </div>
	  </div>		
			<!-- </div>/.product -->
